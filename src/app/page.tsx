      ...
      <section id='team' className='flex w-full flex-col h-full lg:p-12 bg-black bg-cover '>
        <div className='mx-auto max-w-7xl w-11/12'>
          ...
          <div className='flex flex-col lg:flex-row lg:gap-8 gap-12 mx-4 items-center justify-center lg:pb-8 lg:w-full w-10/12'>
            ...
            <div className='hover:shadow-custom flex flex-col bg-indigo-200 mb-12 pb-4 lg:mb-0  lg:h-auto w-[42vh]  gap-[2vh] rounded-xl transform hover:scale-105 transition-transform overflow-hidden relative z-10'>
              <div>
                <Image alt='Shade'
                  src='/Shade.webp'
                  width={403}
