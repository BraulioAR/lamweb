  ...
  <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" width="50" height="50">
    ...
    <g data-name="Layer 2" id="Layer_2">
      ...
      <path d="M19.87,10.41,14.29,16l5.58,5.59a1,1,0,0,1,0,1.41h0a1,1,0,0,1-1.41,0L12.1,16.64a.91.91,0,0,1,0-1.28L18.46,9a1,1,0,0,1,1.41,0h0A1,1,0,0,1,19.87,10.41Z"/>
              ...
              <h1 className={`${tinos.className} text-5xl`}>Fresh and Free</h1>
              </div></div>
                <h2 className={`${tinos.className} text-xl`}>Estos productos alta gama, están diseñados para personas que deseen <br /> cuidar tanto de su piel como de su pelo, esta marca siempre recuerda y <br /> tiene como objetivo decirle al mundo que la belleza es libertad.</h2>
            </div>
            
            <div className='pt-12'>
                 <Image src='/inspiracion9full.webp'
                    alt='Fresh and Free'
                    width={1279}
                    height={975}
